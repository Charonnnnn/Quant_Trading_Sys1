...
class DailyCrawler():
    ...
    def crawl(self, start_date=None, end_date=None):
        ...
        for index,code in enumerate(codes):
            ...
            df_daily['index'] = False
            res = DB_CONN['daily'].insert_many(json.loads(df_daily_hfq.to_json(orient='records')))
...
if __name__ == '__main__':
    ...
    dc = DailyCrawler()
    dc.crawl_index('2014-01-01', '2019-07-30')   # 抓取当日指数
    dc.crawl('2014-01-01', '2019-07-30')         # 抓取当日K线
